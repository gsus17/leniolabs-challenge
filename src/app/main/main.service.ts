...
export class MainService {
  ...
  /** Base url. */
  private baseUrl: string = 'https://api.propublica.org/congress/';
   ...
   */
  public getPersonList$(): Observable<object> {
    const url: string = `${this.baseUrl}v1/116/senate/members.json`;
   ...
   */
  public getPersonListById$(id: string): Observable<object> {
    const url: string = `${this.baseUrl}/v1/members/${id}.json`;

    // tslint:disable-next-line: no-any
    const responseById: any[] = this.response.filter((x) => x.id === id);
    /** return this.httpClient.get(url) */
    return of(responseById);
  }
}
